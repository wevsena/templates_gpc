...
$else$
\usepackage[sfdefault]{roboto} %Alteração de fonte padrão
$endif$
$if(linestretch)$
\usepackage{setspace}
...
\fancypagestyle{firstpage}{
    \fancyhead[C]{\makebox[\textwidth]{\includegraphics[width = \textwidth]{barra_tce_nova.png}}}
...
\pagestyle{fancy}
\fancyhf{}
%\fancyhead[C]{\includegraphics[scale=0.70]{barra_tce.png}}
...
\renewcommand{\headruleskip}{1pt} % Espaçamento da linha do cabeçalho
...
%Nova geometria para as páginas do conteúco
